...
class FirestoreListScreenController extends GetxController {
  //TODO: Implement FirestoreListScreenController
  ...
  void showDialogue(String title, id, value) {
    ...
    Get.defaultDialog(
        ...
        onConfirm: () {
          if (value == "update") {
            ref.doc(id).update({'title': editingController.text}).then((value) {
